...
import { 
  FaCopy, FaPlus, FaPrint, FaCalendarAlt, FaFilter, FaEdit, FaTrash,
  FaFileAlt, FaPalette, FaLayerGroup, FaClipboardList, FaClock, FaSearch,
  FaCheckCircle, FaTimes, FaChartBar, FaUser, FaCalendarDay, FaCalendarWeek
} from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Blanco y Negro</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">A Color</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => openModal()}
              className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded-lg transition-colors duration-200 flex items-center whitespace-nowrap"
            >
                    ...
                    currentItems.map((photocopy) => (
                      <tr key={photocopy.id} className="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="text-xs text-gray-500">
                            {photocopy.doble_hoja ? `${photocopy.cantidad * 2} hojas` : `${photocopy.cantidad} hojas`}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                {editingPhotocopy ? 'Editar Registro' : 'Nuevo Registro de Fotocopia'}
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="flex items-center">
                    ...
                    <span className="ml-2 text-sm text-gray-700">
                      Doble cara (utiliza el doble de hojas)
                    </span>
                  </label>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500"
                    rows="3"
                    placeholder="Ej: Impresión de documentos de trabajo, facturas, contratos..."
                    required
                  />
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  ...
                  >
                    {loading ? 'Guardando...' : editingPhotocopy ? 'Actualizar' : 'Crear Registro'}
                  </button>
                </div>
              </form>
            </div>
